...
# for Regsitering the user and getting the token
...
# For logging in and getting the token
...
class BakeryItemView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        new_bakery_item = BakeryItems.objects.create(
        ...
        for ingredients in data["item_ingredients"]:
            ingredient_obj = Ingredients.objects.get(
                item_name=ingredients["item_name"])
...
# Getting and creating Inventory with empty Inventory obj(associated with user) and ingrident
class InventoryItemsView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        new_inventory_item = InventoryItems.objects.create(
...
# Creating order with bakeryItem and cart(asscociated with logged in user)
class CartItemView(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        new_cart_order = CartOrders(
            cart=cart_obj, order_total=data["order_total"])
        new_cart_order.save()
